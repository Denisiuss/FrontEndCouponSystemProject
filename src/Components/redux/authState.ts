...
export function authReducer(currentState: AuthState = new AuthState(), action:AuthAction):AuthState{
    ...
    switch(action.type){
        ...
        case AuthActionType.LoginUserString:
            ...
            newState.loginUser.userType = (JSON.parse(JSON.stringify(jwt_decode(newState.loginUser.token)))).userType;
            localStorage.setItem("userType",newState.loginUser.userType);
            if(newState.loginUser.userType !== "Administrator"){
